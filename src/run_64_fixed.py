...
SEEN_CSV_PATH = "/kaggle/input/datasets/omvijayshende/dataset-comma-v0/multi_book_dataset.csv"       # Update with your actual path
UNSEEN_CSV_PATH = "/kaggle/input/datasets/omvijayshende/dataset-comma-v0/newbooks_dataset.csv"   # Update with your actual path
